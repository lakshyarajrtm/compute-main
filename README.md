...
A header-only, lightweight C++ linear algebra library designed for computational science, machine learning, and high-performance applications.

## Features

* **Header-Only:** Easy integration—just drop the header into your project and `#include "linalg.hpp"`.
...
### Installation
Simply copy `linalg.hpp` into your project's include directory.
